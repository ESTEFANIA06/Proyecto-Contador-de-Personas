...
def detector(cap: object):
    ...
    while cap.isOpened():
        ...
        cv2.polylines(img=frame, pts=[ZONE2], isClosed=True, color=(0, 0, 255), thickness=3)
...
if __name__ == '__main__':
    cap = cv2.VideoCapture("C:\Users\HP\Documents\TELECOM 8A\CURSO DEEP LEARNING CON PYTHON\Proyeto Curso DEEP LEARNING\video.webm")
    detector(cap)
